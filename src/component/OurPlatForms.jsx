...
const OurPlatForms = () => {
  return (
    ...
    <section className="mx-auto min-h-[70vh] w-5/6 py-20">
          <div className="w-full flex flex-col items-center justify-center mx-auto">
                <div className=" mx-auto p-8 my-4 flex  justify-center">
                     <h1 className="text-4xl sm:text-6xl md:text-center ">One Platform <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-500 font-bold to-blue-600 ">Infinite Possibilities</span></h1>
                 </div>
