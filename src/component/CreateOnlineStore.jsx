  ...
  return (
     <section className=" py-8 sm:py-40">
            <div className="w-full h-[40vh] sm:h-[50vh] relative  cursor-pointer">
                <div className=" sm:w-[90%] rounded-xl  flex flex-col items-center justify-center  mx-auto before:absolute   h-full bg-contain sm:bg-cover  bg-center bg-no-repeat object-contain" style={{backgroundImage:`url(${homepic})`}}>
                    <div className="w-3/5  ">
