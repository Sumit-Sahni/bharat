      ...
      <section className="h-auto py-40 " >
           <div className="px-2 md:w-4/5 flex flex-col items-center mx-auto justify-center">
                <div className="w-full mx-auto px-4 text-center mb-12 py-16">
                        <h1 className="text-xl sm:text-6xl">True Omni-Channel Solution<br/>
               ...
               <div className="w-full lg:w-4/6 border mx-auto flex flex-wrap gap-4 gap-y-10 justify-center h-auto ">
                
                     <div className="relative w-[200px] sm:w-[250px] h-[175px] md:w-[300px] lg:w-[450px] md:h-[300px]  rounded-xl ">
