...
const CustomerLoyalty = () => {
  ...
  return (
      <section className="h-auto mb-24" >
           <div className="px-2 md:w-4/5 flex flex-col items-center mx-auto justify-center align-top">
                <div className="w-full mx-auto px-4 text-center mb-12 py-16">
                        <h1 className="text-2xl sm:text-4xl md:text-5xl">True Omni-Channel Solution<br/>
               ...
               <div className="w-full lg:w-full mx-auto flex flex-wrap gap-4 gap-y-10 justify-center h-auto ">
                
                     <div className="relative w-[350px] md:w-[297px] lg:w-[550px]  h-[175px]   md:h-[300px]  rounded-xl ">
                        <div  className="before:absolute  w-full h-full bg-cover bg-no-repeat z-[-1] rounded-xl " style={{backgroundImage:`url(${homepic})`}}>
                              <div className={`w-3/5 sm:w-1/2 hover:w-3/5 transition duration-500  h-full flex flex-col justify-center items-start  z-10  drop-shadow-2xl text-white  bg-gradient-to-r from-[#0a192f]  px-4 cursor-pointer rounded-xl`}>
                                  <h1 className="px-2 text-sm md:text-2xl text-white font-bold">1. Direct Order Website</h1>
                     ...
                     <div className="relative w-[350px] md:w-[297px] lg:w-[550px]  h-[175px]   md:h-[300px]  rounded-xl ">
                        <div  className="before:absolute  w-full h-full bg-cover bg-no-repeat z-[-1] rounded-xl " style={{backgroundImage:`url(${qr})`}}>
                              <div className={` w-3/5 sm:w-1/2 hover:w-3/5 transition duration-500  h-full flex flex-col justify-center  z-10 items-start text-white drop-shadow-2xl  bg-gradient-to-r from-[#0a192f] px-4 cursor-pointer rounded-xl`}>
                                  <h1 className="px-2 text-sm md:text-2xl text-white font-bold">2. QR Code Solution</h1>
                     ...
                     <div className="relative w-[350px] md:w-[297px] lg:w-[550px]  h-[175px]   md:h-[300px]  rounded-xl ">
                        <div  className="before:absolute  w-full h-full bg-cover bg-no-repeat z-[-1] rounded-xl " style={{backgroundImage:`url(${phoneOrder})`}}>
                              <div className={`w-3/5 sm:w-1/2 hover:w-3/5 transition duration-500  h-full flex flex-col justify-center  z-10 items-start text-white drop-shadow-2xl   bg-gradient-to-r from-[#0a192f] px-4 cursor-pointer rounded-xl`}>
                                  <h1 className="px-2 text-sm md:text-2xl text-white font-bold">3. Phone Ordering</h1> 
                     ...
                     <div className="relative w-[350px] md:w-[297px] lg:w-[550px]  h-[175px]   md:h-[300px]  rounded-xl ">
                        <div  className="before:absolute  w-full h-full bg-cover bg-no-repeat z-[-1] rounded-xl " style={{backgroundImage:`url(${mobileApp})`}}>
                              <div className={`w-3/5 sm:w-1/2 hover:w-3/5 transition duration-500  h-full flex flex-col justify-center  z-10 items-start text-white drop-shadow-2xl   bg-gradient-to-r from-[#0a192f] px-4 cursor-pointer rounded-xl`}>
                                  <h1 className="px-2 text-sm md:text-2xl text-white font-bold">4. Aggregator App</h1>
